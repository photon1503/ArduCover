...
//
// ASCOM CoverCalibrator driver for ArduCover1
//
...
namespace ASCOM.ArduCover1.CoverCalibrator
{
    ...
    //
    // Your driver's DeviceID is ASCOM.ArduCover1.CoverCalibrator
    //
    // The COM Guid attribute sets the CLSID for ASCOM.ArduCover1.CoverCalibrator
    // The COM ClassInterface/None attribute prevents an empty interface called _ArduCover1 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("271734b4-a4ff-4621-b4e2-1a5729837c8d")]
    [ProgId("ASCOM.ArduCover1.CoverCalibrator")]
    [ServedClassName("ArduCover 1")] // Driver description that appears in the Chooser, customise as required
    ...
    public class CoverCalibrator : ReferenceCountedObjectBase, ICoverCalibratorV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArduCover1"/> class. Must be public to successfully register for COM.
        /// </summary>
        public CoverCalibrator()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ArduCover1.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.ArduCover1.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
