...
//----- (UA) (COVER) -----
const uint32_t timeToMoveCover = 10000;  //(ms) time it takes to move between open/close positions (set between 1000(fast)-10000(slow) ms, recommend (5000 ms))
...
const uint8_t primaryServoOpenCoverAngle = 180; //position angle servo opens to, value between (0-180), *may need to be adjusted based on the type of servo used
const uint8_t primaryServoCloseCoverAngle = 0; //position angle servo closes to, value between (0-180), *may need to be adjusted based on the type of servo used
