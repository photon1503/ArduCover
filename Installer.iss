...
;SignTool=MsSign $f
;Encryption=yes
AppID={{79071644-4591-4566-BB33-0AAA585F6DAD}
AppName=ASCOM Ardu Cover #1
AppVersion={#myAppVersion}
AppVerName="ASCOM Ardu Cover #1{#myAppVersion}"
...
OutputDir="."
OutputBaseFilename="ArduCover 1 Setup {#myAppVersion}"
Compression=lzma
SolidCompression=yes
; Put there by Platform if Driver Installer Support selected
;WizardImageFile="C:\Program Files (x86)\ASCOM\Platform 6 Developer Components\Installer Generator\Resources\WizardImage.bmp"
LicenseFile="C:\git\ArduCover\LICENSE"
; {cf}\ASCOM\Uninstall\Telescope folder created by Platform, always
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\ArduCover1"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\ArduCover1"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\git\ArduCover\bin\Release\ASCOM.ArduCover1.exe"; DestDir: "{app}"
[Run]

; Only for .NET local-server drivers
Filename: "{app}\ASCOM.ArduCover1.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.ArduCover1.exe"; Parameters: "/unregister"
